 ...
 */
public class FrmAddGrupo extends javax.swing.JDialog {

        ConectaBanco conecBan= new ConectaBanco();
        
    public FrmAddGrupo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel101.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Nome do Grupo", javax.swing.border.TitledBorder.LEADING, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Arial", 1, 16))); // NOI18N
        jPanel101.setOpaque(false);

        ct_nomeGrupo.setBackground(new java.awt.Color(255, 255, 102));
        ct_nomeGrupo.setFont(new java.awt.Font("Arial", 1, 15)); // NOI18N
        ...
        jPanel101Layout.setHorizontalGroup(
            ...
            .addComponent(ct_nomeGrupo, javax.swing.GroupLayout.DEFAULT_SIZE, 269, Short.MAX_VALUE)
        );
        jPanel101Layout.setVerticalGroup(
            jPanel101Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(ct_nomeGrupo, javax.swing.GroupLayout.DEFAULT_SIZE, 22, Short.MAX_VALUE)
        );
    ...
    private void btn_salvar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_salvar1ActionPerformed
        ...
        try {
            ...
            conecBan.rs.first();
            nomeGrupo= conecBan.rs.getString("nome_grupo");
        ...
        if(ct_nomeGrupo.getText().equals("")){
            ...
            ct_nomeGrupo.setBackground(new Color(252,252,146));
            op1=2;
        }

        if(ct_nomeGrupo.getText().equals(nomeGrupo)){
            ct_nomeGrupo.setBackground(new Color(246,170,170));
            JOptionPane.showMessageDialog(null,"Nome do grupo já existente!","Erro",JOptionPane.ERROR_MESSAGE );
        }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAddGrupo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
